...
if __name__ == "__main__":
    corpus = Corpus('../GloVe-1.2-emsize-200/GloVe_200', 'Thief39', '../../data/250000_tokens_of_validation_users', num_training_tokens_from_validation=2000, num_validation_tokens_from_validation=25000, num_training_tokens_from_anchor=200000, num_similar_users=1)
