...
class Corpus(object):
    def __init__(self, pretrained_embedding, user_name, path, num_training_tokens_from_validation, num_validation_tokens_from_validation, num_training_tokens_from_anchor, num_similar_users):
        ...
        with open("../authorship-classification/similarity_matrix_validation_user_" + str(self.num_tokens_from_validation["training"]) + ".pkl", 'rb') as file:
...
if __name__ == "__main__":
    corpus = Corpus('../../user-embedding-scripts/GloVe-1.2-emsize-200/GloVe_200', 'Thief39', '../../data/250000_tokens_of_validation_users', num_training_tokens_from_validation=2000, num_validation_tokens_from_validation=25000, num_training_tokens_from_anchor=200000, num_similar_users=1)
