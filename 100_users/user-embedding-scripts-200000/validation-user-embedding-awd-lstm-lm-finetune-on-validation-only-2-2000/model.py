...
class RNNModel(nn.Module):
    ...
    def __init__(self, user_name, rnn_type, pretrained_token_embedding, freeze_parameters, ntoken, nuser, token_emsize, user_emsize, nhid, nlayers, dropout=0.5, dropouth=0.5, dropouti=0.5, dropoute=0.1, wdrop=0, tie_weights=False):
        ...
        with open("../../scripts/validation-user-embedding-awd-lstm-lm-2000/model_{" + self.user_name + "}_{2000}.pt", 'rb') as f:
