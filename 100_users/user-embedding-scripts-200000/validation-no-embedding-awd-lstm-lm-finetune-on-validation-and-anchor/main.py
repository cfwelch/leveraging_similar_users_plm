...
import data
import model_no_user_embedding
...
parser.add_argument('--num_training_tokens_from_anchor', type=int, required=True)
parser.add_argument('--multiply', type=int, default=10)
...
corpus = data.Corpus(args.pretrained_token_embedding, args.user_name, args.data, args.num_training_tokens_from_validation, args.num_training_tokens_from_anchor, args.multiply)
...
model = model_no_user_embedding.RNNModel(args.pretrained_model, args.model, args.pretrained_token_embedding, args.freeze_parameters, ntokens, args.token_emsize, args.nhid, args.nlayers, args.dropout, args.dropouth, args.dropouti, args.dropoute, args.wdrop, args.tie_weights)
###
if args.resume:
