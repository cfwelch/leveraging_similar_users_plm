...
class Corpus(object):
   def __init__(self, pretrained_embedding, user_name, path, num_training_tokens_from_validation=200, num_training_tokens_from_anchor=2000000, multiply=10):
       ...
       with open('../validation-user-embedding-awd-lstm-lm-200/model_{' + self.user_name + '}_{200}.pt', 'rb') as f:
   ...
   def prepare_data(self, data_type):
       ...
       if data_type == 'training':
           ...
           token_ids = torch.LongTensor(self.num_training_tokens_from_validation + counter)
