...
class RNNModel(nn.Module):
    ...
    def __init__(self, rnn_type, pretrained_token_embedding, freeze_parameters, ntoken, token_emsize, nhid, nlayers, dropout=0.5, dropouth=0.5, dropouti=0.5, dropoute=0.1, wdrop=0, tie_weights=False):
    ...
    def init_weights(self):
        ...
        if self.tie_weights:
            self.decoder.weight = self.token_encoder.weight
        else:
