...
class Corpus(object):
    def __init__(self, pretrained_embedding, user_name, path, num_training_tokens=2000000, multiply=10):
        ...
        with open('../../../../local2/chenxgu/present_working_directory/validation-user-embedding-awd-lstm-lm-2000/model_{' + self.user_name + '}_{2000}.pt', 'rb') as f:
...
if __name__ == "__main__":
    corpus = Corpus('../GloVe-1.2-emsize-200/GloVe_200', 'wjbc', '../../data/250000_tokens_of_validation_users', num_training_tokens=2000000, multiply=10)
