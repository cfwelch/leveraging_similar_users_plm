...
parser.add_argument('--num_similar_users', type=int, required=True)
...
corpus = data.Corpus(args.pretrained_token_embedding, args.user_name, args.data, args.num_training_tokens_from_validation, args.num_training_tokens_from_anchor, args.num_similar_users)
...
train_token_ids_second = batchify(corpus.training_token_ids_second, args.batch_size, args)
...
def train(first=True):
    if first:
        ...
        local_train_token_ids = train_token_ids_second
