...
parser.add_argument('--num_training_tokens', type=int, default=200000)
...
corpus = data.Corpus(args.pretrained_token_embedding, args.user_name, args.data, args.num_training_tokens, args.num_validation_tokens)
