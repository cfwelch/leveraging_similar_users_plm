...
class Corpus(object):
    def __init__(self, pretrained_embedding, user_name, path, num_training_tokens=2000000, multiply=10, num_validation_tokens=500):
        ...
        print('similarity')
        print(self.simis)
        self.num_tokens_from_anchors = (self.simis / np.sum(self.simis) * multiply * num_training_tokens).astype(np.int)
        print('num tokens from anchors')
        print(self.num_tokens_from_anchors)

        self.num_tokens = {'validation': num_validation_tokens,
                           'test': 25000}
    ...
    def prepare_data(self, data_type):
        ...
        if data_type == 'training':
            ...
            while True:
                ...
                temp_num_tokens_from_anchor = min(20000, self.num_tokens_from_anchors[ordered_anchor_index[current_index]])
...
if __name__ == "__main__":
    corpus = Corpus('../GloVe-1.2-emsize-200/GloVe_200', 'wjbc', '../../data/250000_tokens_of_validation_users', num_training_tokens=2000000, multiply=10, num_validation_tokens=500)
