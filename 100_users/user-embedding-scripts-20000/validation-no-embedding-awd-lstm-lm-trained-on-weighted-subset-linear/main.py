...
parser.add_argument('--num_training_tokens', type=int, default=2000000)
parser.add_argument('--multiply', default=10)
parser.add_argument('--num_validation_tokens', type=int, default=500)
...
corpus = data.Corpus(args.pretrained_token_embedding, args.user_name, args.data, args.num_training_tokens, args.multiply, args.num_validation_tokens)
...
model = model_no_user_embedding.RNNModel(args.model, args.pretrained_token_embedding, args.freeze_parameters, ntokens, args.token_emsize, args.nhid, args.nlayers, args.dropout, args.dropouth, args.dropouti, args.dropoute, args.wdrop, args.tie_weights)
###
if args.resume:
