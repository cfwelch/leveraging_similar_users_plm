...
for i in ${num_token[@]}
do
echo "python main.py --lr 3 --user_name $u --num_training_token $i --data ../../data/250000_tokens_of_validation_users --pretrained_token_embedding '../GloVe-1.2-emsize-200/GloVe_200' --freeze_parameters --token_emsize 200 --user_emsize 50 --batch_size 20 --dropouti 0.2 --dropouth 0.2 --dropout 0.2 --dropoute 0.1 --seed 20190930 --epoch 500 --save model_{$u}_{$i}.pt"
python main.py --lr 3 --user_name $u --num_training_token $i --data ../../data/250000_tokens_of_validation_users --pretrained_token_embedding '../GloVe-1.2-emsize-200/GloVe_200' --freeze_parameters --token_emsize 200 --user_emsize 50 --batch_size 20 --dropouti 0.2 --dropouth 0.2 --dropout 0.2 --dropoute 0.1 --seed 20190930 --epoch 500 --save model_{$u}_{$i}.pt > model_{$u}_{$i}.log
done
done
