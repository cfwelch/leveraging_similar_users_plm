...
def main():
    ...
    # users = ["StabbyPants", "wjbc", "frostyuno", "RobotBuddha", "efrique", "orthag", "mayonesa", "ripster55", "Thief39", "IConrad", "christ0ph", "TheCannon", "ThereisnoTruth", "Pinalope4Real", "TWFM", "sirbruce", "Zeppelanoid", "Zifnab25", "kickstand", "Marvelvsdc00", "DarthContinent", "Radico87", "Aerys1", "poesie"]
    # users = ["StabbyPants", "wjbc", "frostyuno", "RobotBuddha", "efrique", "orthag", "mayonesa", "ripster55", "Thief39", "IConrad", "christ0ph", "TheCannon", "ThereisnoTruth", "Pinalope4Real", "TWFM", "sirbruce", "Zeppelanoid"]
    # users = ["StabbyPants", "wjbc", "frostyuno", "RobotBuddha", "efrique", "orthag", "mayonesa", "ripster55", "Thief39", "IConrad", "christ0ph", "TheCannon", "ThereisnoTruth", "Pinalope4Real", "TWFM"]
    users = ["StabbyPants", "wjbc", "frostyuno", "RobotBuddha", "efrique", "orthag", "mayonesa", "ripster55", "Thief39"]
