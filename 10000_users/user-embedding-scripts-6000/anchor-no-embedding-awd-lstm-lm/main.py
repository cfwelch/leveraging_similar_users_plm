...
val_token_ids = batchify(corpus.validation_token_ids, valid_batch_size, args)
...
model = model.RNNModel(args.model, args.pretrained_token_embedding, args.freeze_parameters, ntokens, args.token_emsize, args.nhid, args.nlayers, args.dropout, args.dropouth, args.dropouti, args.dropoute, args.wdrop, args.tie_weights)
###
if args.resume:
...
def train():
    ...
    while i < train_token_ids.size(0) - 1 - 1:
        ...
        model.train()
        inputs, targets = get_batch(train_token_ids, i, args, seq_len=seq_len)
...
try:
    ...
    for epoch in range(1, args.epochs+1):
        ...
        if 't0' in optimizer.param_groups[0]:
            ...
            val_loss2 = evaluate(val_token_ids, valid_batch_size)
            print('-' * 89)
            ...
            val_loss = evaluate(val_token_ids, valid_batch_size)
            print('-' * 89)
            print('| end of epoch {:3d} | time: {:5.2f}s | valid loss {:5.2f} | valid ppl {:8.2f} | valid bpc {:8.3f}'.format(
