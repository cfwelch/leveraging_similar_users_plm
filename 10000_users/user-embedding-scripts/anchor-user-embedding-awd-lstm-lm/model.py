...
class RNNModel(nn.Module):
    ...
    def __init__(self, rnn_type, pretrained_token_embedding, freeze_parameters, ntoken, nuser, token_emsize, user_emsize, nhid, nlayers, dropout=0.5, dropouth=0.5, dropouti=0.5, dropoute=0.1, wdrop=0, tie_weights=False):
...
if __name__ == '__main__':
    model = RNNModel('LSTM', '../GloVe-1.2-emsize-200/GloVe_200', True, 55428, 100, 200, 10, 1150, 3, 0.2, 0.2, 0.2, 0.1, 0, False)
