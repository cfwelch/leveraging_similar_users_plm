...
parser.add_argument('--num_validation_tokens', type=int, required=True,
...
corpus = data.Corpus(args.pretrained_token_embedding, args.user_name, args.num_training_tokens, args.num_validation_tokens, args.data)
