...
class Corpus(object):
    def __init__(self, pretrained_embedding, users_type, path, num_training_token_per_user, num_validation_token_per_user):
        with open(pretrained_embedding + '_dictionary.pkl', 'rb') as file:
            self.dictionary = pickle.load(file)
        self.vocab_size = len(self.dictionary)
        self.users = []
        with open('/scratch/mihalcea_root/mihalcea1/chenxgu/data_10000/' + users_type + '.txt', 'r') as file:
            for line in file:
        ...
        self.num_tokens_per_user = {'training': num_training_token_per_user,
                                    'validation': num_validation_token_per_user,
                                    'test': 20000}
...
def main():
    corpus = Corpus('../GloVe-1.2-emsize-200/GloVe_200', 'anchor_users', '../../../../local/chenxgu/present_working_directory/data_10000/60000_tokens_of_anchor_users', 200, 200)
