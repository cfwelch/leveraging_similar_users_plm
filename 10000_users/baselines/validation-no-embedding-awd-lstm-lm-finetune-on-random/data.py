...
class Corpus(object):
    ...
    def prepare_data(self, data_type):
        ...
        if data_type == 'training_anchor':
            ...
            num_tokens_from_each_anchor = 2000
...
if __name__ == "__main__":
    corpus = Corpus('../../user-embedding-scripts/GloVe-1.2-emsize-200/GloVe_200', 'kcstrike', '../../data_10000/60000_tokens_of_validation_users', num_training_tokens_from_validation=2000, num_validation_tokens_from_validation=2000, num_anchor_users=10)
